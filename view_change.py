...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        graph_1 = add_graph("graph_1")
        self.add_graphic(graph_1.graph)
        self.name_add_graph(graph_1.graph)
        graph_2 = add_graph("graph_2")
        self.add_graphic(graph_2.graph)
        self.name_add_graph(graph_2.graph)
...
"background-color: rgb(170, 85, 255);")
    ...
    def add_graphic(self, add_graphic):
        self.menu_graphics.addTab(add_graphic, "")
        self.menu.addTab(self.graphics, "")

    def name_add_graph(self,add_graphic):
        _translate = QtCore.QCoreApplication.translate
        self.menu_graphics.setTabText(self.menu_graphics.indexOf(add_graphic), _translate("MainWindow", str(add_graphic)))
